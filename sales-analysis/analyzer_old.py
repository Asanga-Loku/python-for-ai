#remember to install ranbow csv extension to VS Code
#The VS Code setting Python › Terminal: Execute In File Dir (ticked) is important so you know where they are running
